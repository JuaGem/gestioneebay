...
<html lang="it">
	...
	<link rel="mask-icon" href="${pageContext.request.contextPath}/assets/img/favicons/safari-pinned-tab.svg" >
	...
	<body class="text-center">
		...
		<form class="form-signin" name='login' action="login" method='POST' novalidate="novalidate">
		  ...
		  <a class="btn" href="${pageContext.request.contextPath }/registration" role="button">Non hai un account? Iscriviti</a>
