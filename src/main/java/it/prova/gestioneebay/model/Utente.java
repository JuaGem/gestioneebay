...
public class Utente {
	...
	@NotBlank(message = "{username.notblank}", groups = {RegistrationParam.class, EditParam.class})
	...
	@NotBlank(message = "{nome.notblank}", groups = {RegistrationParam.class, EditParam.class})
	@Column(name = "nome")
	private String nome;

	@NotBlank(message = "{cognome.notblank}", groups = {RegistrationParam.class, EditParam.class})
	@Column(name = "cognome")
	private String cognome;

	@Min(value = 0, groups = EditParam.class)
	...
	public String toString() {
		return "Utente [id=" + id + ", username=" + username + ", password=" + password + ", nome=" + nome
				+ ", cognome=" + cognome + ", creditoResiduo=" + creditoResiduo + ", dateCreated=" + dateCreated
				+ ", stato=" + stato + "]";
	}
