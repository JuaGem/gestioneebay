		...
		<div class='card'>
		    ...
		    <div class='card-body'>
		    	...
		    	<dl class="row">
                  ...
                  <dd class="col-sm-9"><fmt:formatDate type = "date" value = "${dettaglio_articolo_attr.dataPubblicazione}" /></dd>
            	</dl>
		    ...
		    <div class='card-footer'>
		        <a href="${pageContext.request.contextPath }/public/list" class='btn btn-outline-secondary' style='width:80px'>
		            <i class='fa fa-chevron-left'></i> Back
		        </a>
		        <a id="changeStatoLink_#_${dettaglio_articolo_attr.id }" class="btn btn-outline-success link-for-modal" data-toggle="modal" data-target="#confirmBuyModal">Acquista</a>
		    </div>
		</div>	
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <br/>
               <b> PREZZO : ${dettaglio_articolo_attr.prezzo } </b>
            </div>
            <form method="post" action="${pageContext.request.contextPath }/acquisti/listAcquisti" >
                <div class="modal-footer">
                    <input type="hidden" name="idAcquistoForBuy" id="idAcquistoForBuy">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Chiudi</button>
                    <input type="submit" value="Continua"  class="btn btn-primary btn-success"> 
                </div>
            </form>
        </div>
    </div>
