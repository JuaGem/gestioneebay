		...
		<div class='card'>
		    ...
		    <div class='card-body'>
					...
					<form method="post" action="${pageContext.request.contextPath}/utente/list" >
						...
						<a class="btn btn-outline-primary ml-2" href="${pageContext.request.contextPath}/registration">Add New</a>
						
						<br/>
						Ruoli:
						<div class="form-check">
						<c:forEach items="${ruoli_list_attribute}" var="ruoloItem">
						  <input name="ruoli" class="form-check-input" type="checkbox" value="${ruoloItem.id}" id="defaultCheck1${ruoloItem.id}">
						  <label class="form-check-label" for="defaultCheck1${ruoloItem.id}">
