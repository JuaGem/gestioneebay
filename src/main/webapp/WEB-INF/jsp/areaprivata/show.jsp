	...
	<main role="main" class="container">
		...
		<div class='card'>
		    ...
		    <div class='card-body'>
					...
					<form:form modelAttribute="utente_registration_attribute" method="post" action="${pageContext.request.contextPath}/areaprivata/edit" novalidate="novalidate">
						<input type="hidden" name="id" id="id" value="${utente_registration_attribute.id}" >
						...
						<div class="form-row">	
							...
							<div class="form-group col-md-6">
								...
								<spring:bind path="password">
									<input type=password name="password" id="password"class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire password" value="" autocomplete="new-password" >
