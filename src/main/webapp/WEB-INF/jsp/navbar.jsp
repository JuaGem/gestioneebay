    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown01">
          ...
          <a class="dropdown-item" href="${pageContext.request.contextPath}/areaprivata">Area Privata</a>
          <a class="dropdown-item" href="${pageContext.request.contextPath}/areaprivata/list">I tuoi annunci</a>
          <a class="dropdown-item" href="${pageContext.request.contextPath}/acquisti/list">I tuoi acquisti</a>
        </div>
      </li>
      <sec:authorize access="hasRole('ADMIN')">
	      <li class="nav-item dropdown">
	        ...
	        <div class="dropdown-menu" aria-labelledby="dropdown01">
	          ...
	          <a class="dropdown-item" href="${pageContext.request.contextPath}/registration">Inserisci Utente</a>
	        </div>
	      </li>
	   </sec:authorize>
    </ul>
